 ...
 * summary="Insert new customer",
 * description="Regsiter Quotation <br> ข้อมูลลูกค้า",
 ...
 *          @OA\Schema(
 *              required={
 *                        "BRANCH_TYPE", "BRANCH_ID", "TAX_ID", "OCCUPATION_ID", "UNIVERSITY_ID", "FACULTY_ID", "PRODUCT_SERIES", "DOWN_SUM_AMT",
 *                        "PREFIX", "FIRST_NAME", "LAST_NAME", "BIRTHDAY", "SEX", "MARITAL_STATUS", "PHONE", "EMAIL", 
 *                        "OCCUPATION_ID", "MAIN_INCOME", "UNIVERSITY_PROVINCE", "UNIVERSITY_NAME", "FACULTY_NAME", "LEVEL_TYPE", "U_LEVEL", "LOAN_KYS", "REF_TAX_ID", 
 *                        "REF_TITLE", "REF_FIRSTNAME", "REF_LASTNAME", "RELATION_REFERENCE", "REF_OCCUPATION", "REF_BIRTHDAY", "REF_PHONE", "IDCARD_FILE", "STUDENTCARD_FILE", 
 *                        "FACE_FILE", "STUDENT_ID", 
 *                        "A1_NO", "A1_PROVINCE", "A1_DISTRICT", "A1_SUBDISTRICT", "A1_POSTALCODE", "A1_OWNER_TYPE", "A2_NO", "A2_PROVINCE", "A2_DISTRICT", "A2_SUBDISTRICT", "A2_POSTALCODE", "A2_OWNER_TYPE", "A3_NO", "A3_PROVINCE", "A3_DISTRICT", "A3_SUBDISTRICT", "A3_POSTALCODE", "A3_OWNER_TYPE"
 *                       },
 * 
 *              @OA\Property(property="BRANCH_TYPE", type="string", format="string", example="1"),
 *              @OA\Property(property="BRANCH_ID", type="string", format="string", example="31"),
